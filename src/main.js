    ...
    if (operacionesParseadas.length > 0) {
        ...
        operacionesParseadas.forEach((operacion) => {
            ...
            <div class="flex justify-between mt-6">
                ...
                <div class="text-gray-600 font-bold m-auto ${operacion.tipo === "Ganancia"
                    ? "text-green-600"
                    : "text-red-600"
                }">
                    ${operacion.monto}
...
function cargarCategoriasNueva() {
    ...
    categoriaNuevaOperacion.innerHTML = '<option value="Seleccione una opcion">Seleccione una opcion</option>';
...
function crearOperacion() {
    ...
    const descripcionNuevaOperacion = document.getElementById('descripcion-nueva-operacion').value;
    const montoNuevaOperacion = document.getElementById('monto-nueva-operacion').value;
    const tipoNuevaOperacion = document.getElementById('tipo-nueva-operacion').value;
    const categoriaNuevaOperacion = document.getElementById('categoria-nueva-operacion').value;
    const fechaNuevaOperacion = document.getElementById('fecha-nueva-operacion').value;

    // Validar que el usuario haya seleccionado un tipo y una categoría válidos
    if (tipoNuevaOperacion === "Seleccione una opción" || categoriaNuevaOperacion === "Seleccione una opción") {
...
function cargarCategorias(categorias) {
    ...
    categoriasFiltro.innerHTML = '<option value="Seleccionar">Seleccionar</option>'; // Limpiar las opciones previas
